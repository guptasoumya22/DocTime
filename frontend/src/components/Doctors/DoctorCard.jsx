...
const DoctorCard = ({doctor}) => {
  ...
  return (
    <div className='p-3 lg:p-5'>
      ...
      <h2 className='text-[18px] leading-[30px] lg:text-[26px] lg:leading-9 text-black
      font-[700] mt-3 lg:mt-5'>{name}</h2>
      <div className='mt-2 lg:mt-4 flex items-center justify-between'>
        <span className='bg-[#CCF0F3] text-skyblue py-1 px-2 lg:py-2
            lg:px-6 text-[12px] leading-7 font-semibold rounded'>
         {specialization}
        </span>
        ...
        <span className='test-[14px] leading-6 lg:text-[16px] lg:leading-7 font-[400]
        text-neutral '>
            ({totalRating})
        </span>
      </div>
    ...
    <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
        <div>
            ...
            text-black'>+{totalPatients} patients</h3>
            <p className='test-[14px] leading-6 font-[400] text-neutral'>
                At {hospital}
            </p>
        </div>
