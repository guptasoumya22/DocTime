                    ...
                    <div className="rounded-l-lg lg:pl-16 py-10">
                        ...
                        <div className="mb-5 ">
                         <input 
                                ...
                                className="w-full py-3 border-b border-solid border-[#0066ff61]
                                           focus:outline-none focus:border-b-primary text-[18px] leading-7
                                         text-black placeholder:text-neutral rounded-md cursor-pointer"
                                required
                         />
                        </div>
                        <div className="mb-5 ">
                        ...
                        <div className="mb-5 flex items-center gap-3">
                            ...
                            <div className="relative w-[160px] h-[50px]">
                                ...
                                px-[2rem] py-[0.375rem] text-[15px] leading-6 overflow-hidden bg-[#0066ff46] text-black
                                font-semibold rounded-lg truncate cursor-pointer">Upload Photo</label>
                            </div>
                        </div>
                        <div className="mt-7">
                            <button type="submit" className="w-full bg-primary text-white
                                    text-[18px] leading-[30px] rounded-lg px-4 py-2">Signup</button>
                        </div>
                        <p className="mt text-gray-500 text-center">Already have an account? <Link to='/login' className="text-primary ml-1">Login</Link></p>
                        </form>
                    </div>
                </div>
            </div>
